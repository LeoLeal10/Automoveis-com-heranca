...
namespace N2B2_POO
{
    public partial class ucNavioGuerra : UserControl
    {
        
        public ucNavioGuerra()
        {
            InitializeComponent();
        }
        ...
        private void btnCadastrar_Click(object sender, EventArgs e)
        {
            try
            {
                NavioGuerra item = new NavioGuerra(txtID.Text,
        ...
        private void ucNavioGuerra_Load(object sender, EventArgs e)
        {
