...
namespace N2B2_POO
{
    public partial class ucAviaoGuerra : UserControl
    {
        
        public ucAviaoGuerra()
        {
            InitializeComponent();
        }
        ...
        private void btnCadastrar_Click(object sender, EventArgs e)
        {
            try
            {
                AviaoGuerra item = new AviaoGuerra(txtID.Text,
        ...
        private void ucAviaoGuerra_Load(object sender, EventArgs e)
        {
